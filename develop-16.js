...
// 구조분해 할당 방식 : 구조를 분해하여, 변수로 할당(만드는) 방식으로, 복잡한 객체를 다룰 때, 간결하게 코드를 작성 할 수 있도록 모던 javascript에서 지원하고 있음
// 본 예제와 같은 경우는 큰 의미가 없지만, 프로토콜 관련 큰 객체를 다루면서, 특정 속성만 사용을 원하는 등, '억양'에 따라 코드 자체의 직관성을 높일 수 있음
